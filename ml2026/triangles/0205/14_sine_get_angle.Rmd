...
deg = round(asin(opp2/hyp)/pi*180)
```
...
Please round your answer to the nearest degree.
...
Depending on your calculator, you might type something like ``arcsin(`r opp2`/`r hypt`)``. Make sure you are in degree mode.
