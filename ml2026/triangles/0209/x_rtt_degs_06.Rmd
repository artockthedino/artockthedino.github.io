...
if(qt==1){ #ol=hl*sin(th)
    ...
    atag = paste0("$$\\sin(",ang,")=\\frac{x}{",hyp,"}$$\n$$x=",hyp,"\\cdot\\sin(",ang,")$$\n\n $$x=",ans,"$$")
}
if(qt==2){ #hl=ol/sin(th)
    ...
    ansstr = sprintf("%.1f",ans)
    atag = paste0("$$\\sin(",ang,")=\\frac{",opp,"}{x}$$\n$$x=\\frac{",opp,"}{\\sin(",ang,")}$$\n\n $$x=",ans,"$$")
}
if(qt==3){ #th=asin(ol/hl)
    ...
    ansstr = sprintf("%.1f",ans)
    atag = paste0("$$\\sin(x)=\\frac{",opp,"}{",hyp,"}$$\n$$x=\\arcsin\\left(\\frac{",opp,"}{",hyp,"}\\right)$$\n\n $$x=",ans,"$$")
}
if(qt==4){ #al=hl*cos(th)
    ...
    ansstr = sprintf("%.1f",ans)
    atag = paste0("$$\\cos(",ang,")=\\frac{x}{",hyp,"}$$\n$$x=",hyp,"\\cdot\\cos(",ang,")$$\n\n $$x=",ans,"$$")
}
if(qt==5){ #hl=al/cos(th)
    ...
    ansstr = sprintf("%.1f",ans)
    atag = paste0("$$\\cos(",ang,")=\\frac{",adj,"}{x}$$\n$$x=\\frac{",adj,"}{\\cos(",ang,")}$$\n\n $$x=",ans,"$$")
}
if(qt==6){ #th=acos(al/hl)
    ...
    ansstr = sprintf("%.1f",ans)
    atag = paste0("$$\\cos(x)=\\frac{",adj,"}{",hyp,"}$$\n$$x=\\arccos\\left(\\frac{",adj,"}{",hyp,"}\\right)$$\n\n $$x=",ans,"$$")
}
...
if(qt==9){ #th=atan(ol/al)
    ...
    ansstr = sprintf("%.1f",ans)
    atag = paste0("$$\\tan(x)=\\frac{",opp,"}{",adj,"}$$\n$$x=\\arctan\\left(\\frac{",opp,"}{",adj,"}\\right)$$\n\n $$x=",ans,"$$")
}
if(qt==10){
    opp = signif(ol,3)
    adj = signif(al,3)
...
On the right triangle below, find the unknown length or angle (in degrees).
...
Remember pythagorean theorem (for finding a side length from the other two side lengths).

$$(\text{adj})^2+(\text{opp})^2=(\text{hyp})^2$$

Remember SOH-CAH-TOA (for relating side-length ratios to angles).
