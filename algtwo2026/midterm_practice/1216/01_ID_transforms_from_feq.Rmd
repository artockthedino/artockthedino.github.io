...
The horizontal transformations are determined by the operations inside the argument of the function. The vertical transformations are determined by the operations outside the function.
    
Notice, the horizontal transformations are kind of "backwards" in order and effect from what you'd expect based on PEMDAS. The vertical transformations are intuitive.


It is easiest to see why by setting the arguent equal to $a$. Start by writing down the given equation.
