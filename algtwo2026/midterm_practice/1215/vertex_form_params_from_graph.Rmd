...
points(h,k,col="orange",pch=19)
text(h,k,paste0("(",h,", ",k,")"),col="orange",adj=c(0.5,0.5+sign(a)),cex=1.5)

points(h+1,k+a,col="blue",pch=19)
text(h+1,k+a,paste0("(",h+1,", ",k+a,")"),col="blue",adj=c(-0.2,0.5),cex=1.5)


# lines(c(h,h+1),c(k,k),col="pink")
arrows(h+1,k,h+1,k+a,0.15,20,col="red",lwd=2)
text(h+1,k+a/2,gsub("+-","-",paste0("+",a),fixed=T),col="red",adj=c(-0.2,0.5),cex=1.5)
