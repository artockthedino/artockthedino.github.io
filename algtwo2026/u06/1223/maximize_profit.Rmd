...
Construct the weekly profit function by multiplying the per-widget profit by the number of widgets sold per week.

$$P=(x-`r sprintf("%.2f",u)`)\cdot(`r i*100`-`r m*100`x)$$

Expand (by FOIL or box) the profit function.
