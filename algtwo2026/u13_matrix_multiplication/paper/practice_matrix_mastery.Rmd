...
## Practice Matrix Mastery (`r params$titex` v`r params$rseed`)
...
for(i in 0:10){
    lines(c(0,10),c(i,i),lwd=lwd1)
    lines(c(i,i),c(0,10),lwd=lwd1)
}
for(i in c(5,10)){
    lines(c(0,10),c(i,i),lwd=lwd2)
    lines(c(i,i),c(0,10),lwd=lwd2)
}
# abline(h=0,lwd=1.5)
# abline(v=0,lwd=1.5)
arrows(-1,0,10.3,0,0.05,15,lwd=1.6)
arrows(0,-1,0,10.3,0.05,15,lwd=1.6)

for(i in 1:4){
    points(U[1,i],U[2,i],pch=19)
}
polygon(U[1,1:4],U[2,1:4],lwd=2,density=25)
text(10,-0.2,"x")
text(-0.2,10,"y")
...
for(i in -15:15){
    lines(c(-15,15),c(i,i),lwd=lwd1)
    lines(c(i,i),c(-15,15),lwd=lwd1)
}
for(i in seq(-15,15,5)){
    lines(c(-15,15),c(i,i),lwd=lwd2)
    lines(c(i,i),c(-15,15),lwd=lwd2)
}
# abline(h=0,lwd=1.5)
# abline(v=0,lwd=1.5)

pp = 15.5
arrows(-pp,0,pp,0,0.05,25,3,lwd=1.6)
arrows(0,-pp,0,pp,0.05,25,3,lwd=1.6)

polygon(A[1,],A[2,],lwd=2,density=25)
