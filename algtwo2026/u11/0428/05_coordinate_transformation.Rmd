...
For every point $(a,b)$ on the curve $b=f[a]$ there is a corresponding point on the curve $y=g[x]$. What is the rule that describes this coordinate transformation?
...
We can also substitute $y$ for $g[x]$ and substitute $b$ for $f[a]$.
