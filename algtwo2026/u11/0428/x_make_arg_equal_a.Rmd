...
The equation below defines a curve made by horizontal transformations of an (unknown) function $f$.

$$y~=~f\left[`r q`\right]$$

What value of $x$ makes the argument equal to `r y`?

Solution
========

Set the argument equal to `r y`.
$$`r ques`$$
`r s1`
