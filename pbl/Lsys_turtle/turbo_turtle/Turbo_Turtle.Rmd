...
## Turbo Turtle (directions for `Turbo Turtle Pic`)
...
1. **Save your turtle project AS A COPY**. Name the copy "Turbo Turtle".
2. Make variables.\
![](variables.png)
...
![](s_pams_1.png)
10. In Scratch, click the green flag. Paste the string into the popup. Hit ENTER. Use **Turbo Mode**.
11. Take a screenshot of the resulting image (including your turtle). Submit your image on Canvas under assignment `Turbo Turtle Pic`.
