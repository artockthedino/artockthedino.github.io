...
9. **DOCUMENT** your own favorite 6 patterns in a slideshow!
    * Adjust the parameters in the top of the code, click the green flag to run the code.
        ...
        * **DO NOT** let drawing hit edge of screen. Use a smaller `scale` value or adjust `start_x` and `start_y` if this happens. I typically start with `scale`=1, or even `scale`=0.1, and then increase it until it fills the space (while tinkering with `start_x` and `start_y`).
